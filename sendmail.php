...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    try {
        ...
        $mail->SMTPAuth = true;
        $mail->Username = 'toothandsmiledentistry@gmail.com'; // your Gmail
        $mail->Password = 'owxyukoegbeogocs'; // 16-character Gmail App Password
        $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
        $mail->Port = 587;

        // Sender and recipient
        $mail->setFrom('toothandsmiledentistry@gmail.com', 'Tooth & Smile Website');
        $mail->addAddress('vasanthvenkat0000@gmail.com'); // Dentist email
